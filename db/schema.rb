...
ActiveRecord::Schema[7.0].define(version: 2022_11_30_134639) do
  ...
  create_table "itineraries", force: :cascade do |t|
    ...
    t.string "phase", default: "in plan"
  ...
  create_table "lists", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "status"
    t.index ["itinerary_id"], name: "index_lists_on_itinerary_id"
  end
  ...
  create_table "users_itineraries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["itinerary_id"], name: "index_users_itineraries_on_itinerary_id"
    t.index ["user_id"], name: "index_users_itineraries_on_user_id"
  end
  ...
  add_foreign_key "lists", "itineraries"
